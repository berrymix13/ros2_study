...
class MultiSpawning(Node):
    def __init__(self):
        ...
        self.teleport = self.create_client(TeleportAbsolute, '/turtle1/teleport_absolute')   # client
        self.req_teleport = TeleportAbsolute.Request()   # client

        self.spawn = self.create_client(Spawn, '/spawn')   # client
        self.req_teleport = TeleportAbsolute.Request()   # client
        self.req_spawn = Spawn.Request()   # client
    ...
    def callback_service(self, request, response):
        # my service server request part
